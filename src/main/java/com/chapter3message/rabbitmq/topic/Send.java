...
public class Send implements RabbitTemplate.ConfirmCallback {
    ...
    public String sendMsg(String content) {
        ...
        //rabbitTemplate.convertAndSend(AmqpConfig.EXCHANGE, "weather-routingKey.a", content, correlationId);
        //能被1、2同时匹配
        rabbitTemplate.convertAndSend(AmqpConfig.EXCHANGE, "weather-routingKey.a", content, correlationId);
        return null;
    }
    ...
    public String sendMsg2(String content) {
    	CorrelationData correlationId = new CorrelationData(UUID.randomUUID().toString());
    	rabbitTemplate.convertAndSend(AmqpConfig.EXCHANGE, "weather-routingKey.abc.def", content, correlationId);
    	return null;
    }
