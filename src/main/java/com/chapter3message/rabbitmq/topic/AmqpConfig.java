package com.chapter3message.rabbitmq.topic;
...
/**topic此类交换器使得来自不同的源头的消息可以到达一个对列，其实说的更明白一点就是模糊匹配的意思，
 * 例如：#代表匹配0个或多个单词，*代表匹配任意一个词。因此"usa.#"能够匹配到"usa.news.XXX和usa.XXX"，但是"usa.*"只会匹配到"usa.XXX"。
 * @author dell
 *
 */
@Configuration
public class AmqpConfig {
    ...
    public static final String ROUTINGKEY = "weather-routingKey.*";
    //public static final String ROUTINGKEY2 = "msg-routingKey.#";
    public static final String ROUTINGKEY2 = "weather-routingKey.#";
    ...
    public Binding binding() {
    	return BindingBuilder.bind(queue()).to(topicExchange()).with(AmqpConfig.ROUTINGKEY);
    }
    ...
    public Binding binding2() {
    	return BindingBuilder.bind(queue2()).to(topicExchange()).with(AmqpConfig.ROUTINGKEY2);
    }
